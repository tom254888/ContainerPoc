...
/**
 * Servlet implementation class Shousai
 */
@WebServlet("/Shousai")
public class ShousaiServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (userName == null) {
			...
			this.getServletContext().getRequestDispatcher("/eturan.jsp").forward(request, response);
			System.out.println("After dispatch /eturan.jsp");
		}
	}
