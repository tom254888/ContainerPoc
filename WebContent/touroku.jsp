...
<body>
 ...
 -->
	...
	<div class="container-fluid" style="background-color: SeaGreen;">
		<center>
			<%
				out.print(request.getAttribute("formTitle")); //表のタイトル 登録画面
			%>
		</center>
	</div>
	<br>
	...
	<form method=post action="/ContainerPoc/Update">
		<div class="container">
		 ...
		 -->
			...
			<div style="margin-left: auto;">
				<button style="width: 100px;"
					class="btn btn-outline-success my-2 my-sm-0" type="submit" disabled>編集</button>
				<button style="width: 100px;"
					class="btn btn-outline-success my-2 my-sm-0" type="submit">一時保存</button>
				<button style="width: 100px;"
					class="btn btn-outline-success my-2 my-sm-0" type="submit">発信</button>
				<button style="width: 100px;"
					class="btn btn-outline-success my-2 my-sm-0" type="submit" disabled>削除</button>

				<input type="text" name="searchid" hidden
					value=<%out.print(bean.getNOTICE_ID());%>>
			</div>
			...
			<table class="table-bordered" style="height: 103px; width: 900px;"
				...
				<tbody>
					...
					<tr>
						...
						<td style="width: 900px;"><input type="text"
							class="form-control" id="buten_name" name="buten_name"
							value=<%out.print(bean.getBUTEN_NAME());%>></td>
					</tr>
					<tr>
						<td style="width: 149px; background-color: LightGreen;">掲示担当者</td>
						<td style="width: 900px;"><input type="text"
							class="form-control" id="tanto_name" name="tanto_name"
							value=<%out.print(bean.getTANTO_NAME());%>></td>
					</tr>
					<tr>
						<td style="width: 149px; background-color: LightGreen;">件名</td>
						<td style="width: 900px;"><input type="text"
							class="form-control" id="notice_title" name="notice_title"
							value=<%out.print(bean.getNOTICE_TITLE());%>></td>
					</tr>
					<tr>
						<td style="width: 149px; background-color: LightGreen;">備考</td>
						<td style="width: 900px;"><textarea
								class="form-control text-left" id="notice_note"
								name="notice_note" rows="4">
							<%
				...
				<tbody>
					<tr>
						...
						<td style="width: 900px;">
							<div>
								<label>ファイルを添付してください。</label>

								<div class="input-group mb-3">
									<div class="custom-file">
										<input type="file" class="custom-file-input" id="upload1">
										<label class="custom-file-label" for="upload1">ファイルを選択</label>
									</div>
							...
							<div>
								...
								<div class="input-group mb-3">
									<div class="custom-file">
										...
										<label class="custom-file-label" for="upload2">ファイルを選択</label>
									</div>
									<div class="input-group-append">
										<button class="btn btn-outline-secondary" type="button">Upload</button>
									</div>
					...
					<tr>
						...
						<td style="width: 900px;">
							<div>
								...
								<div class="input-group mb-3">
									<div class="custom-file">
										<input type="file" class="custom-file-input" id="upload3">
										<label class="custom-file-label" for="upload3">ファイルを選択</label>
									</div>
									<div class="input-group-append">
										<button class="btn btn-outline-secondary" type="button">Upload</button>
									</div>
					...
					<tr>
						...
						<td style="width: 900px;">
							<div>
								...
								<div class="input-group mb-3">
									<div class="custom-file">
										<input type="file" class="custom-file-input" id="upload4">
										<label class="custom-file-label" for="upload4">ファイルを選択</label>
									</div>
									<div class="input-group-append">
										<button class="btn btn-outline-secondary" type="button">Upload</button>
									</div>
